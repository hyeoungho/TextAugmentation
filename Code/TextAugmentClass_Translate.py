...
class TextAugmentationClass:
    def __init__(self, outputpath, thval=0.8):
        ...
        self.client = SecretClient(vault_url="https://uifdataaugment.vault.azure.net", credential=self.credential)
        self.subscription_key = self.client.get_secret("TranslatorKey").value
